...
const AppSettingsSchema = CollectionSchema(
  ...
  properties: {
    r'firstRecordDate': PropertySchema(
      id: 0,
      name: r'firstRecordDate',
...
void _appSettingsSerialize(
  ...
  writer.writeDateTime(offsets[0], object.firstRecordDate);
...
AppSettings _appSettingsDeserialize(
  ...
  object.firstRecordDate = reader.readDateTimeOrNull(offsets[0]);
  object.id = id;
...
extension AppSettingsQueryFilter
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
      firstRecordDateIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'firstRecordDate',
      ));
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
      firstRecordDateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
      firstRecordDateEqualTo(DateTime? value) {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingsQuerySortBy
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> sortByFirstRecordDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstRecordDate', Sort.asc);
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterSortBy>
      sortByFirstRecordDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstRecordDate', Sort.desc);
    });
  }
...
extension AppSettingsQuerySortThenBy
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> thenByFirstRecordDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstRecordDate', Sort.asc);
    });
  }
...
extension AppSettingsQueryWhereDistinct
  ...
  QueryBuilder<AppSettings, AppSettings, QDistinct>
      distinctByFirstRecordDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'firstRecordDate');
    });
  }
...
extension AppSettingsQueryProperty
  ...
  QueryBuilder<AppSettings, DateTime?, QQueryOperations>
      firstRecordDateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'firstRecordDate');
    });
  }
